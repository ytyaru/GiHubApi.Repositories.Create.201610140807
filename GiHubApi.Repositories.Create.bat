...
curl --cacert %CURL_PEM% -o %RESPONSE% -H %HDR_TIMEZONE% -H %HDR_AUTHOR% -H "Content-Type: application/json; charset=utf-8" -X POST https://api.github.com/user/repos --data-binary @%POST_PARAM_UTF8%
